...
## Determining the rate of large number of zero incidences ####
...
## Carrier data ####
saveRDS(object = carrier_ts, file = "./data/carrier_ts.rds")

## Control data ####
saveRDS(object = control_ts, file = "./data/control_ts.rds")